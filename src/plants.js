...
// ─── 3-D visual config ────────────────────────────────────────────────────────
const PALETTES = [
  { petal: '#fef08a', center: '#f59e0b', stem: '#22c55e' },
  { petal: '#fb7185', center: '#be185d', stem: '#15803d' },
  { petal: '#c084fc', center: '#7c3aed', stem: '#15803d' },
  { petal: '#67e8f9', center: '#0891b2', stem: '#22c55e' },
  { petal: '#fcd34d', center: '#d97706', stem: '#15803d' },
  { petal: '#f9a8d4', center: '#db2777', stem: '#22c55e' },
  { petal: '#a5b4fc', center: '#4f46e5', stem: '#15803d' },
  { petal: '#86efac', center: '#16a34a', stem: '#15803d' },
  { petal: '#fdba74', center: '#ea580c', stem: '#22c55e' },
  { petal: '#e879f9', center: '#c026d3', stem: '#15803d' },
  { petal: '#fca5a5', center: '#dc2626', stem: '#22c55e' },
  { petal: '#bef264', center: '#65a30d', stem: '#15803d' },
]

const MUSHROOM_IDS = new Set(['corpse_flower', 'christmas_cactus'])

export function getPlantVisual(plantId) {
  if (!plantId) return PALETTES[0]
  const hash = [...plantId].reduce((a, c) => a + c.charCodeAt(0), 0)
  const palette = PALETTES[hash % PALETTES.length]
  const isMushroom = MUSHROOM_IDS.has(plantId) || plantId.includes('mushroom')
  return {
    ...palette,
    type: isMushroom ? 'mushroom' : 'flower',
    petals: 4 + (hash % 6),  // 4–9 petals
  }
}
